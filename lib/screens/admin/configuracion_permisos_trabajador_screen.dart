...
class _ConfiguracionPermisosTrabajadorScreenState
  ...
  void _toggleFuncion(String funcion, bool valor) async {
    ...
    // Validación para permisos de turnos de trabajadores
    final permisosTurnosTrabajadores = [
      'crearEditarTurno',
      'registroTurnosRealizados',
    ];

    if (valor && permisosTurnosTrabajadores.contains(funcion)) {
      try {
        final condominioId = widget.currentUser.condominioId;
        if (condominioId == null) {
          if (mounted) {
    ...
    // Validación para permisos de mensajes
    ...
    if (valor && permisosMensajes.contains(funcion)) {
      try {
        final condominioId = widget.currentUser.condominioId;
        if (condominioId == null) {
          if (mounted) {
